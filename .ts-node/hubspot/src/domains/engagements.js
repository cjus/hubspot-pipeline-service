...
exports.buildEngagementsDomain = buildEngagementsDomain;
var paginate_1 = require("../core/paginate");
function buildEngagementsDomain(send) {
    var _this = this;
    var api = {
        listEngagements: function (params) {
            var _a;
            ...
            return send({ method: "GET", path: "/crm/v3/objects/".concat(objectType), query: query });
        },
        getEngagement: function (params) {
            var _a;
            var objectType = params.objectType, id = params.id;
            var query = {};
            if ((_a = params === null || params === void 0 ? void 0 : params.properties) === null || _a === void 0 ? void 0 : _a.length)
                query.properties = params.properties.join(",");
            return send({ method: "GET", path: "/crm/v3/objects/".concat(objectType, "/").concat(id), query: query });
        },
        streamEngagements: function (params) {
            return __asyncGenerator(this, arguments, function () {
                var objectType, query, _a, _b, _c, items, _i, items_1, item, e_1_1;
                var _d, e_1, _e, _f;
                var _g;
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        ...
                        case 1:
                            ...
                            _a = true, _b = __asyncValues((0, paginate_1.paginateCursor)({ send: send, path: "/crm/v3/objects/".concat(objectType), query: query, pageSize: params === null || params === void 0 ? void 0 : params.pageSize }));
                            _h.label = 2;
        ...
        getEngagements: function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        _a = true, _b = __asyncValues(api.streamEngagements(params));
                        _g.label = 2;
